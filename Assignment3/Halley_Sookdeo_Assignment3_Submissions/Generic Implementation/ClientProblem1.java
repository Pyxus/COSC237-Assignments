...
public class ClientProblem1 {
    public static void main(String[] args) {
        UnorderedArrayList<Integer> list_1 = readIntegersFromFile(30, "Please input the name of the file to be opened for first list: ");
        UnorderedArrayList<Integer> list_2 = readIntegersFromFile(30, "Please input the name of the file to be opened for second list: ");
        ...
        UnorderedArrayList<Integer> result = list_1.merge(list_2);
        result.print();
    ...
    public static UnorderedArrayList<Integer> readIntegersFromFile(int maxSize, String prompt) {
        Scanner cin = new Scanner(System.in);
        UnorderedArrayList<Integer> list = new UnorderedArrayList<Integer>(maxSize);
        boolean fileFound;
        int i = 0;
