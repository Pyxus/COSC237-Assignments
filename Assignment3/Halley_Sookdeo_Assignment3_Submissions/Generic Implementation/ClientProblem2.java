...
public class ClientProblem2 
{
    ...
    {
        OrderedArrayList<Integer> list_1 = readIntegersFromFile(30, "Please input the name of the file to be opened for first list: ");
        OrderedArrayList<Integer> list_2 = readIntegersFromFile(30, "Please input the name of the file to be opened for second list: ");
        ...
        OrderedArrayList<Integer> result = list_1.merge(list_2);
        result.print();
    ...
    public static OrderedArrayList<Integer> readIntegersFromFile(int maxSize, String prompt) {
        Scanner cin = new Scanner(System.in);
        OrderedArrayList<Integer> list = new OrderedArrayList<Integer>(maxSize);
        boolean fileFound;
        int i = 0;
