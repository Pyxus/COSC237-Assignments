...
public class ClientMerge_2 {
    ...
    public static void main(String[] args) {
        ...
        num = input.nextInt(); //call your own getInt(0 method)
        while (num != 999) {
        ...
        list3.print(); System.out.println("\nThe length of the merged list is: " +
        list3.length());
        ...
        System.out.println("Enter key for split: "); num = input.nextInt(); //call your own getInt() method
        list3.split(list1, list2, num); System.out.print("\nThe first list after split is: "); list1.print(); System.out.print("\nThe second list after split is: "); list2.print(); System.out.println();
    }
}